...
<div style="background-color: #ffc374; padding: 4px; border-radius: 3px;">
<form>
<label>Sporter Naam:</label><br>
<input type="text" placeholder="Klik hier om te typen..."><br>
<label>Sporter E-mail:</label><br>
<input type="email" placeholder="Klik hier om te typen..."><br>
<label for="text">Typ hier uw vraag:</label><br>
