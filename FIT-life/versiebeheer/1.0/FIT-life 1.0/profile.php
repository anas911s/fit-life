...
<br><br>
<h3 style="font-weight: bold; background-color: #ffc374; padding: 4px; border-radius: 3px;">FIT-LIFE</h3>
<p style="background-color: #ffc374; padding: 4px; border-radius: 3px;">Welkom bij de FIT-life sportschool zijn Officiële Website.<br>
Hier vind u alle informatie over onze sportschool. U kunt een account aanmaken via <a href="register.php">hier</a>! <br>
Zodra u een account heeft kunt u via <a href="login.php">hier</a> inloggen. <br>
Met een account kunt u als sporter worden aangemeld en krijgt u een unieke profiel. <br>
